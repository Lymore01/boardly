defmodule BoardlyWeb.Router do
  use BoardlyWeb, :router

  import BoardlyWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BoardlyWeb.Layouts, :root}
  ...
  # scope "/api", BoardlyWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:boardly, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BoardlyWeb.Telemetry
